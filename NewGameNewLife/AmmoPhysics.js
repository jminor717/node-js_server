async function AmmoPhysics(THREE) {
	...
	function getShape(geometry) {
		...
		if (geometry.type === 'BoxGeometry') {
			...
			// 	points.push(new AmmoLib.btVector3(vertex.x, vertex.y, vertex.z))
			// }
			// const shape = new AmmoLib.btConvexTriangleMeshShape(points);
			// shape.setMargin(0.05);
	...
	function setGravity(x, y, z) {
		world.setGravity(new AmmoLib.btVector3(x, y, z));
	}
	...
	return {
		...
		getVelocity: getMeshVelocity,
		setVelocity: setMeshVelocity
